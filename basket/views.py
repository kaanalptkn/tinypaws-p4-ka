...
def view_basket(request):
    """  This view  for renders the basket contents page """

    return render(request, 'basket/basket.html')

def add_to_basket(request, item_id):
    """ This section for adding a quantity of the selected product to the shopping basket """
...
def modify_basket(request, item_id):
    """This section modifying the quantity of the specified product to the specified amount"""
